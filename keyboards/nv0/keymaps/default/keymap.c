...
[_UPPER] = LAYOUT(
  ...
  KC_ESC, ____,   ____,    ____,    ____,    ____,             KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, ____,     ____,
  ____,   ____,   ____,    ____,    ____,    ____,             KC_INS,  ____,    ____,  KC_RGUI, ____,     ____,
...
[_BASE] = LAYOUT(
  ...
  KC_LGUI,  KC_Z,   KC_X,    KC_C,     KC_V,     KC_B,          KC_N,    KC_M,     KC_COMM, KC_DOT,  KC_SLSH, KC_EQL,
                    KC_LALT, KC_LOWER, KC_LSFT,  KC_ENT,        KC_SPC,  KC_RSFT,  KC_BSPC, KC_DEL
),
};
